...
abstract class $WritingRequestCopyWith<$Res> {
  factory $WritingRequestCopyWith(
          WritingRequest value, $Res Function(WritingRequest) then) =
...
abstract class _$$WritingRequestImplCopyWith<$Res>
    implements $WritingRequestCopyWith<$Res> {
  factory _$$WritingRequestImplCopyWith(_$WritingRequestImpl value,
...
class __$$WritingRequestImplCopyWithImpl<$Res>
  ...
  __$$WritingRequestImplCopyWithImpl(
      _$WritingRequestImpl _value, $Res Function(_$WritingRequestImpl) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$WritingRequestImpl(
      type: null == type
          ? _value.type
          : type // ignore: cast_nullable_to_non_nullable
              as String,
...
abstract class _WritingRequest implements WritingRequest {
  const factory _WritingRequest(
      ...
      required final String recipientRole}) = _$WritingRequestImpl;

  @override
  String get type;
  @override // 'Email', 'CoverLetter', 'Outreach'
  String get context;
  @override
  String get tone;
  @override
...
abstract class $GeneratedContentCopyWith<$Res> {
  factory $GeneratedContentCopyWith(
          GeneratedContent value, $Res Function(GeneratedContent) then) =
...
abstract class _$$GeneratedContentImplCopyWith<$Res>
    implements $GeneratedContentCopyWith<$Res> {
  factory _$$GeneratedContentImplCopyWith(_$GeneratedContentImpl value,
...
class __$$GeneratedContentImplCopyWithImpl<$Res>
  ...
  __$$GeneratedContentImplCopyWithImpl(_$GeneratedContentImpl _value,
  ...
  $Res call({
    ...
    return _then(_$GeneratedContentImpl(
      id: null == id
          ? _value.id
          : id // ignore: cast_nullable_to_non_nullable
              as String,
...
abstract class _GeneratedContent implements GeneratedContent {
  const factory _GeneratedContent(
      ...
      required final DateTime generatedAt}) = _$GeneratedContentImpl;
